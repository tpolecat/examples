...
object Batnum extends BASIC with App {
  ...
  640 IF N > A THEN 720
  650 LET W := 1
  660 PRINT "COMPUTER TAKES " // TODO: allow printing of multiple exprs
  661 PRINT N
  662 PRINT " AND LOSES"
  670 RETURN // TODO: fix DSL so blank line isn't required

  680 IF N > B THEN 720
  690 LET W := 1
  700 PRINT "COMPUTER TAKES " // TODO: allow printing of multiple exprs
  701 PRINT N
  702 PRINT " AND WINS"
  710 RETURN
  ...
  760 LET P := B
  770 LET N := N - P
  780 PRINT "COMPUTER TAKES "
  781 PRINT P
  782 PRINT " AND LEAVES "
  783 PRINT N
  790 LET W := 0
  800 RETURN
